  ...
  <a href="{{ route('user.level')}}" class="btn btn-primary" style="border-radius: 15px; margin-bottom: 12px; float: right; ">Finish <i class="fa fa-flag "></i></a>
      ...
      <div class="templatemo-flex-row flex-content-row">
          <div class="lesson-content-widget white-bg col-md-12">              
              ...
              <div class="col-md-12">  
                <h2 class="text-center round-box-title" >Awumazino Yerr Libu Yelamottorr Levaranu</h2>
              ...
              <div class="col-md-12">
                <h2 class="text-center round-box-title">Awumazino Iriyanu</h2>
                <div class="table-responsive mt-4">
                    <table class="table">
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <h2 class="text-center round-box-title">Awumazino Ciriyanu</h2>
                    <div class="table-responsive mt-4">
                        <table class="table">
                    ...
                    <div class="col-md-12">
                        <h2 class="text-center round-box-title">Awumazino Kiriyanu</h2>
                        <div class="table-responsive mt-4">
                            <table class="table">
