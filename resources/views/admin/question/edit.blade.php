        ...
        <div class="col-md-10 mt-2">
          ...
          @endif
              <div class="card card-info">
                ...
                <!-- /.card-header -->
                <!-- form start -->
              <form class="form-horizontal" method="post" action="{{route('admin.question.update',$question->id)}}">
                @method('PUT')
                @csrf
                  <div class="card-body">
                  ...
                  <div class="card-footer">
                    ...
                    <a href="{{ route('admin.question.index')}}" class="btn btn-default float-right">Back</a>
                  </div>
                  <!-- /.card-footer -->
                </form>
              </div>
