    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12 mt-2">
            ...
            <span class="info-box-icon bg-info"><a href="{{ route('admin.question.create')}}" ><i class="fa fa-plus"></i></a></span>
      ...
      <table class="table table-bordered table-responsive-md">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="{{route('admin.question.edit',$question->id)}}" class="btn btn-app w-25"> <i class="fas fa-edit"></i> Edit</a>
