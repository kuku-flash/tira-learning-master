...
<section class="content">
        ...
        <div class="col-md-10 mt-2">
         ...
         @endif
              <div class="card card-info">
                ...
                <!-- /.card-header -->
                <!-- form start -->
              <form class="form-horizontal" method="post" action="{{route('admin.option.update',$option->id)}}">
                @csrf
                @method('PUT')
                  <div class="card-body">
  ...
  <input type="text" class="form-control @error('option_text') is-invalid  @enderror" name="option_text"  value="{{$option->option_text}}">
                  ...
                  <div class="card-footer">
                    ...
                    <a href="{{route('admin.option.index')}}" class="btn btn-default float-right">Cancel</a>
                  </div>
                  <!-- /.card-footer -->
                </form>
              </div>
