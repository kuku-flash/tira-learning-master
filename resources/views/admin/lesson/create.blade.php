      ...
      <div class="row">
        <div class="col-md-10 mt-2">
              ...
              <div class="card card-info">
                ...
                <!-- /.card-header -->
                <!-- form start -->
              <form class="form-horizontal" method="post" action="{{route('admin.lesson.store')}}" enctype="multipart/form-data">
                @csrf
                  <div class="card-body">
                  ...
                  <div class="card-footer">
                    ...
                    <a href="{{route('admin.lesson.index')}}" class="btn btn-default float-right">Cancel</a>
                  </div>
                  <!-- /.card-footer -->
                </form>
              </div>
