    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12 mt-2">
            ...
            <span class="info-box-icon bg-info"><a href="{{ route('teacher.option.create')}}" ><i class="fa fa-plus"></i></a></span>
      ...
      <table class="table table-bordered table-responsive-md">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="{{route('teacher.option.edit',$option->id)}}" class="btn btn-app w-25"> <i class="fas fa-edit"></i> Edit</a>
              <a href="javascript:void(0)" onclick="$(this).parent().find('form').submit()" class="btn btn-app"><i class="fas fa-trash"></i>delete</a>
                <form action="{{ route('teacher.option.destroy',$option->id)}}" method="post">
                  @method('DELETE')
