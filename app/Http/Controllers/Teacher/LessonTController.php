...
class LessonTController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('teacher.lesson.index')->with($arr);
    }
    ...
    public function create()
    {
        ...
        return view('teacher.lesson.create')->with($arr);
    }
    ...
    public function store(Request $request, Lesson $lesson)
    {
        ...
        $lesson->save();
        return redirect()->route('teacher.lesson.index')->with('success','New lesson added successfully');
    }
    ...
    {
        $arr['lesson'] = $lesson;
        return view('teacher.lesson.show')->with($arr);
    }
    ...
    public function edit(Lesson $lesson)
    {
        $arr['lesson'] = $lesson;
        $arr['topics'] = Topic::all();
        return view('teacher.lesson.edit')->with($arr);
    }
    ...
    public function update(Request $request, Lesson $lesson)
    {
        ...
        return redirect()->route('teacher.lesson.edit',$lesson->id)->with('success','lesson Updated successfully');
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('teacher.lesson.index')->with('success','Lesson removed successfully');
    }
}
